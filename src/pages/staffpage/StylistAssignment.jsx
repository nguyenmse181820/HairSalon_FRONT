...
function StylistAssignment() {
    ...
    useEffect(() => {
        axios.get('https://673a9c49339a4ce445188ccb.mockapi.io/project/stylistAssignment').then((res) => {
            setStylist(res.data)
        })
    })
    ...
    const handleSubmit = (e) => {
        ...
        } else if (!formData.avatar.startsWith('https://') && !formData.avatar.startsWith('http://')) {
    ...
    return (
        <div>
            ...
            <div className='sm:ml-6 lg:ml-10 ml-6 mt-10 text-sm sm:text-base flex justify-center border w-max px-4 py-2 transform hover:scale-110 hover:bg-black hover:text-white transition-all ease-in-out duration-500'>
                <button onClick={toggleCreateModal} className='font-semibold'>Create new Stylist</button>
            </div>
            {/* table */}
                ...
                <table className='w-full'>
                    <thead className=''>
                        <tr className='sm:text-base text-sm'>
                            ...
                            <th className='hidden sm:table-cell py-3 px-2 font-semibold text-center uppercase'>Email</th>
                            <th className='py-3 px-2 font-semibold text-center uppercase'>Stylist Name</th>
                            <th className='py-3 px-2 font-semibold text-center uppercase'>Avatar</th>
                            <th className='hidden sm:table-cell py-3 px-2 font-semibold text-center uppercase'>Phone</th>
                            <th className='hidden md:table-cell py-3 px-2 font-semibold text-center uppercase'>Address</th>
                            <th className='hidden md:table-cell py-3 px-2 font-semibold text-center uppercase'>Age</th>
                        ...
                        {stylist.map((stylist) => {
                            return (
                                <tr key={stylist.id} className='sm:text-base text-sm'>
                                    ...
                                    <td className='hidden sm:table-cell py-3 px-2'>{stylist.email}</td>
                                    <td className='py-3 px-2'>{stylist.stylistName}</td>
                                    <td className='py-3 px-2 flex justify-center'><img src={stylist.avatar} alt="" className='w-20 h-20 rounded-full' /></td>
                                    <td className='hidden sm:table-cell py-3 px-2'>{stylist.phone}</td>
                                    <td className='hidden md:table-cell py-3 px-2'>{stylist.address}</td>
                                    <td className='hidden md:table-cell py-3 px-2'>{stylist.age}</td>
                                    <td className='py-3 px-2'>
                                        <div className='flex justify-center items-center gap-1 sm:gap-2 sm:flex-row flex-col'>
                                            <button onClick={() => toggleEditModal(stylist)} className='border transform hover:scale-110 hover:bg-gray-700 hover:bg-opacity-20 py-1 px-2 w-[80%] lg:w-[80px] transition-all ease-in-out duration-500'>Edit</button>
                                            <button onClick={() => toggleDeleteModal(stylist)} className='border transform hover:scale-110 bg-red-500 text-white hover:bg-red-600 py-1 px-2 w-[80%] lg:w-[80px] transition-all ease-in-out duration-500'>Delete</button>
            ...
            {editModal && (
                <div className='modal'>
                    ...
                    <div className='modal-content rounded border shadow-md z-50 fixed h-[80%] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
                        ...
                        <div className='w-[80%]'>
                            ...
                            <form action="">
                                <div className='mb-4 mx-10'>
                                    ...
                                    />
                                    {errors.email && <span className='text-red-500 italic text-sm'>{errors.email}</span>}
                                </div>
                                <div className='mb-4 mx-10'>
                                ...
                                <div className='mb-4 mx-10'>
                                    ...
                                    <input type="text"
                                        ...
                                        onChange={handleEditChange}
                                    />
                                    {errors.avatar && <span className='text-red-500 italic text-sm'>{errors.avatar}</span>}
                                </div>
                                <div className='mb-4 mx-10'>
                                    ...
                                    <input type="number"
                                        ...
                                        onChange={handleEditChange}
                                    />
                                    {errors.phone && <span className='text-red-500 italic text-sm'>{errors.phone}</span>}
                                </div>
                                <div className='mb-4 mx-10'>
                                    ...
                                    <input type="text"
                                        ...
                                        onChange={handleEditChange}
                                    />
                                    {errors.address && <span className='text-red-500 italic text-sm'>{errors.address}</span>}
                                </div>
                                <div className='mb-4 mx-10'>
                                    <label>Age</label> <br />
                                    <input type="number"
                                        ...
                                        onChange={handleEditChange}
                                    />
                                    {errors.age && <span className='text-red-500 italic text-sm'>{errors.age}</span>}
                                </div>
            ...
            {createModal && (
                <div className='modal '>
                    ...
                    <div className='modal-content rounded border shadow-md h-[90%] fixed z-50 top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2
                     bg-white py-16 my-10 overflow-y-auto md:mt-16 lg:mt-[100px] w-[80%] md:w-[60%] lg:w-[35%] flex justify-center'>
                        <div className='w-[80%]'>
                            <form action="">
                                <div className='text-lg text-center font-bold uppercase tracking-wider my-10'>Create New Stylist</div>
                                <div className='mb-4'>
                                ...
                                <div className='mb-4'>
                                    ...
                                    <input type="text"
                                        ...
                                        onChange={handleChange}
                                    />
                                    {errors.avatar && <span className='text-red-500 text-sm italic'>{errors.avatar}</span>}
                                </div>
                                <div className='mb-4'>
                                ...
                                <div className='flex justify-center items-center gap-4 mt-10 py-10'>
                                    <button onClick={handleSubmit} className='bg-white text-black border px-4 py-2 w-[100px] transform hover:scale-110 hover:bg-black hover:text-white transition-all ease-in-out duration-500'>Submit</button>
                                    <button onClick={handleReset} className='bg-black text-white border px-4 py-2 w-[100px] transform hover:scale-110 hover:bg-white hover:text-black transition-all ease-in-out duration-500'>Clear</button>
                                </div>
                            </form>
                        </div>
