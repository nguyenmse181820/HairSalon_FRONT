...
const LandingPage = () => {
    ...
    return (
        <div className='min-h-screen flex justify-center items-center'>
            <div className='mt-2'>
                <div className='top-banner flex justify-center w-full z-0'>
                    <div className='flex relative justify-center w-full'> {/* Relative to control the absolute element */}
                ...
                <div className='middle-banner flex justify-center items-center h-full'>
                    <div className='lg:flex relative justify-center items-center'> {/* Parent container */}
