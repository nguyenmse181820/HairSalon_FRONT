...
const AboutUs = () => {
  ...
  return (
    <div>
      <div className="mt-10 mx-4 sm:mx-8 lg:px-40">

        {/* Section Title */}
        <div className="flex justify-center mb-10">
          <h1 className="text-2xl sm:text-3xl font-bold font-serif text-center">OUR JOURNEY AT COIFFURE</h1>
        </div>

        {/* First Section */}
        <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
          <img
            className="lg:w-4/12 w-full h-auto mb-4 lg:mb-0"
            src={Image1AboutUs}
            alt="Salon Interior"
          />
          <div className="lg:w-6/12 w-full text-center lg:text-left px-2">
            <h2 className="text-xl sm:text-2xl font-bold mb-2">Our Story</h2>
            <p className="text-sm sm:text-base mb-4 leading-snug sm:leading-tight">
        ...
        <div className="flex flex-col-reverse lg:flex-row justify-between items-center mb-12">
          <div className="lg:w-6/12 w-full text-center lg:text-left px-2">
            <h2 className="text-xl sm:text-2xl font-bold mb-2">Haircuts & Styling</h2>
            <p className="text-sm sm:text-base mb-4 leading-snug sm:leading-tight">
            ...
            <button
              ...
              className="px-4 sm:px-6 py-2 bg-black text-white font-bold hover:bg-gray-800 transition-all"
            >
              BOOK A CUT
            </button>
          </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
          ...
          />
          <div className="lg:w-6/12 w-full text-center lg:text-left px-2">
            <h2 className="text-xl sm:text-2xl font-bold mb-2">Coloring & Highlights</h2>
            <p className="text-sm sm:text-base mb-4 leading-snug sm:leading-tight">
