            ...
            <div className="bg-white w-full max-w-md p-6">
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <span className="ml-8">{stylist.name}</span>
                    </div>
                    <div>
                        <span className="font-semibold">EMAIL:</span>{" "}
                        <span className="ml-8">{stylist.email}</span>
                    </div>
                    <div>
                        <span className="font-semibold">PHONE:</span>{" "}
                        <span className="ml-8">{stylist.phone}</span>
                    </div>
                    <div>
                        <span className="font-semibold">BIRTHDAY:</span>{" "}
                        <span className="ml-8">{stylist.birthday}</span>
                    </div>
                    <div>
                        <span className="font-semibold">EXPERIENCE:</span>{" "}
                        <span className="ml-8">{stylist.experience} years</span>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        {Array.isArray(stylist.specialty) ? (
                            ...
                            <span className="ml-8">{stylist.specialty || "No specialties listed"}</span>
                        )}
                    </div>
                </div>
