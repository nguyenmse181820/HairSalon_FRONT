    ...
    <header>
      <div className="sticky-container fixed w-full z-10 bg-white">
        ...
        <div className="middle-header-row flex items-center justify-center">
          <a className="flex justify-center  " href="/stylist/home">
        ...
        <div className="menustylist-bar">
          <ul className="hidden lg:flex justify-center items-center space-x-[7rem] list-none pt-2">
            <li>
              <a
                href="/stylist/home"
                className="nav-link font-semibold text-sm uppercase"
              >
                HOME
              </a>
            </li>
            ...
            <li>
              ...
              {isOpen && (
                <ul className="absolute bg-white text-black z-50 w-[220px] border">
                  <li className="py-2 px-2 font-semibold text-sm uppercase hover:bg-black hover:bg-opacity-90 hover:text-white transition-all ease-in-out duration-500">
                    <a href="/stylist/appointment_view">View Appointment</a>
                  </li>
                  <li className="py-2 px-2 font-semibold text-sm uppercase hover:bg-black hover:bg-opacity-90 hover:text-white transition-all ease-in-out duration-500">
                    <a href="/stylist/appointment_management">
            ...
            <ul className="flex flex-col items-center space-y-8 text-xl">
              ...
              <li className="flex flex-col items-center relative">
                <button
                  onClick={() => setIsOpen((prev) => !prev)}
                  type="button"
                  className="nav-link font-semibold text-xl uppercase "
                >
                  Appointment
                </button>
                {isOpen && (
                  <ul className="absolute flex flex-col text-center justify-center z-50 items-center bg-black text-white w-[280px] my-10 ">
                    <li className="py-2 px-[46px] w-full font-semibold text-sm uppercase hover:bg-white hover:bg-opacity-30">
                      <a href="/stylist/appointment_view">View Appointment</a>
                    </li>
                    <li className="py-2 px-[14px] w-full font-semibold text-sm uppercase hover:bg-white hover:bg-opacity-30">
                      <a href="/stylist/appointment_management">
                        Management Appointment
                      </a>
                    </li>
